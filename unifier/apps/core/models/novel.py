...
class Novel(StandardModelMixin):
    ...
    description = models.CharField(blank=True, null=True, max_length=128, verbose_name="Novel description")
    rate = models.DecimalField(blank=False, null=False, max_digits=2, decimal_places=2, verbose_name="Novel rate")
